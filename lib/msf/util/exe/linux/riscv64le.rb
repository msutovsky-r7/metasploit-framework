module Msf::Util::EXE::Linux::Riscv64le
  ...
  module ClassMethods
    ...
    def to_linux_riscv64le_elf(framework, code, opts = {})
      Msf::Util::EXE::Common.to_exe_elf(framework, opts, "template_riscv64le_linux.bin", code)
    end
    ...
    def to_linux_riscv64le_elf_dll(framework, code, opts = {})
      Msf::Util::EXE::Common.to_exe_elf(framework, opts, "template_riscv64le_linux_dll.bin", code)
    end
  end
