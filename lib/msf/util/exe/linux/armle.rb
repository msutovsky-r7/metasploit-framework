...
include Msf::Util::EXE::Linux::Common
  ...
  module ClassMethods
    ...
    def to_linux_armle_elf(framework, code, opts = {})
      Msf::Util::EXE::Common.to_exe_elf(framework, opts, "template_armle_linux.bin", code)
    end
    ...
    def to_linux_armle_elf_dll(framework, code, opts = {})
      Msf::Util::EXE::Common.to_exe_elf(framework, opts, "template_armle_linux_dll.bin", code)
    end
  end
